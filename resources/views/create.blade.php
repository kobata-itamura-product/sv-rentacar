                    ...
                    <div class="rentacar-box__flex">
                      <div class="rentacar-box__item">
                        <div class="rentacar-box__img">
                          <img src="/sv-rentacar/storage/images/マセラッティ車両.png" class="rentacar-box__img-first" alt=""><p><img src="/sv-rentacar/assets/images/360カメラ.png" class="rentacar-box__img-first_icon" alt=""></P>
                        ...
                        <form method="POST" action="{{action('CarmodelController@store')}}" enctype="multipart/form-data">
                          @csrf
                          <label for="model_name" class="form-label">モデル名:</label>
                          <input id="model_name" type="text" name="model_name" class="form-control" required>
                      ...
                      <div class="rentacar-box__item">
                        <div class="rentacar-box__img">
                          <a href="assets/images/maserati/maserati_ghibli-bl-1.jpg"><img src="/sv-rentacar/storage/images/マセラッティ車両2.png" class="rentacar-box__img-first" alt=""></a>
                          <div class="rentacar-box__imgs">
                        ...
                        <div class="rentacar-box__img">
                          <a href="assets/images/maserati/maserati_levante-gs-1.jpg"><img src="/sv-rentacar/storage/images/マセラッティ車両3.png" class="rentacar-box__img-first" alt="レヴァンテ グランスポーツ"></a>
                          <div class="rentacar-box__imgs">
